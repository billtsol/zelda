...
class Item:
    ...
    def diplay_names(self,surface,name,cost,selected):
        ...
        # cost
        cost_surface = self.font.render(f'{int(cost)}',
                                        False,color)
    ...
    def display(self, surface,selection_number,name,value,max_value,cost):
        ...
        self.diplay_names(surface,name,cost,self.index == selection_number)
